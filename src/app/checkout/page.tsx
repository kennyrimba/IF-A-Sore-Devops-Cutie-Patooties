                                        ...
                                        <div className="payment-block md:mt-10 mt-6">
                                            ...
                                            <div className="list-payment mt-5">
                                                ...
                                                <div className={`type bg-surface p-5 border border-line rounded-lg mt-5 ${activePayment === 'cash-delivery' ? 'open' : ''}`}>
                                                    ...
                                                    <div className="infor">
                                                        <div className="text-on-surface-variant1 pt-4">Product will be paid when it arrives, you will still need to enter your credit card information for total unpaid on delivery.</div>
                                                        <div className="row">
                                                            <div className="col-12 mt-3">
